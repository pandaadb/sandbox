...
public class DownloadTest extends io.dropwizard.Application<DBConfiguration> {
	@Override
	...
	public static void main(String[] args) throws Exception {
		new DownloadTest().run("server", "/home/artur/dev/repo/sandbox/src/main/resources/config/test.yaml");
	}
